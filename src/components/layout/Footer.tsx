...
export function Footer() {
  return (
    <footer className="mt-20 bg-stone-900 py-12 text-stone-300">
      <div className="container-app grid gap-10 md:grid-cols-3">
        <div>
          ...
          <p className="mt-3 max-w-sm text-sm leading-6">
            Receitas práticas e inspiradoras para transformar ingredientes simples em bons momentos.
          </p>
        </div>
        <div>
          <h2 className="font-bold text-white">Navegação</h2>
      ...
      <div className="container-app mt-10 border-t border-stone-700 pt-6 text-sm">
        © {new Date().getFullYear()} Sabor & Receita. Projeto para portfólio.
      </div>
    </footer>
  );
}
